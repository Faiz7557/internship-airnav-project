...
<div class="max-w-4xl mx-auto animate-enter pt-10 pb-20">
    ...
    <div class="flex flex-col md:flex-row justify-between items-center mb-12 gap-6">
        <div class="relative">
            <h1 class="text-4xl font-black text-transparent bg-clip-text bg-gradient-to-r from-[#1F3C88] to-blue-500 font-outfit tracking-tight drop-shadow-sm">Tambah Event</h1>
            <div class="h-1 w-20 bg-blue-500 rounded-full mt-2"></div>
            <p class="text-slate-500 font-medium mt-3 text-lg">Buat event baru untuk dashboard.</p>
        </div>
    ...
    <div class="relative group">
        ...
        <div class="relative glass-card rounded-[2.5rem] p-10 md:p-14 border border-white/80 shadow-2xl overflow-hidden bg-white/60 backdrop-blur-2xl">
            ...
            <form action="{{ route('admin.events.store') }}" method="POST" class="space-y-10">
                @csrf
                ...
                <div class="space-y-4">
                    ...
                    <div class="relative group/input">
                        ...
                        <input type="text" id="name" name="name" 
                            ...
                            placeholder="Contoh: Angkutan Lebaran 2024" value="{{ old('name') }}" required>
                    </div>
                ...
                <div class="space-y-4">
                    ...
                    <div class="p-2 bg-white/60 rounded-[1.5rem] border-2 border-slate-100 flex items-center gap-6 shadow-sm hover:shadow-md transition-all duration-300 group/color focus-within:border-blue-300 focus-within:ring-4 focus-within:ring-blue-500/10">
                        <div class="relative w-20 h-20 flex-shrink-0">
                            ...
                            <div id="color_preview" class="w-full h-full rounded-2xl shadow-inner border border-black/5 transition-transform duration-300 group-hover/color:scale-105" style="background-color: {{ old('color', '#ef4444') }}"></div>
                ...
                <div class="space-y-4">
                    ...
                    <div class="relative">
                        <textarea id="description" name="description" rows="4" 
                            ...
                            placeholder="Tuliskan detail event di sini...">{{ old('description') }}</textarea>
